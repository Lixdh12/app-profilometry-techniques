...
class Trigger():
    ...
    def acquire_images(self,cam, nodemap, nodemap_tldevice, name_file):
        """
        ...
        try:
            ...
            IMAGE_HEIGHT = self.resolution[1] #800  #540 pixels default | 1024 max
            IMAGE_WIDTH = self.resolution[0] #1280 #720 pixels default | 1280
            HEIGHT_OFFSET = 64 # Y, to keep in middle of sensor
            #WIDTH_OFFSET = -1 * round((720-IMAGE_WIDTH)/2) # X, to keep in middle of sensor
            ...
            # You are using pip version 22.0.4; however, version 22.3 is available.
                ...
                try:
                    ...
                    if image_result.IsIncomplete():
                        ...
                        if device_serial_number:
                            filename = 'Trigger-%s-%d00_%dx%d.png' % (name_file, randint(0,5),width, height)
    ...
    def run_single_camera(self,cam, name_file):
        """
        ...
        try:
            ...
            # Acquire images
            result &= self.acquire_images(cam, nodemap, nodemap_tldevice, name_file)
    ...
    def main(self, name_file, resolution):
        ...
        for i, cam in enumerate(cam_list):
            ...
            result &= self.run_single_camera(cam, name_file)
